...
@Service
public class SoapOtpremnicaUMaloprodajuService {
    ...
    private OtpremnicaUMaloprodaju constructOtpremnicaUMaloprodaju(
        ...
        for (int i = 0; i < itemsArray.length(); i++) {
            ...
            PriceInfoDTO prices = priceCheckService.checkPrices(system, storeCode, itemJson.getString("sku"), pricelist);
    ...
    private String convertToSoapRequest(OtpremnicaUMaloprodaju otpremnicaUMaloprodaju, String system, String storeCode, String pricelist) {
        ...
        for (OtpremnicaUMaloprodaju.StavkaOtpremnice stavka : otpremnicaUMaloprodaju.getStavke()) {
            ...
            PriceInfoDTO prices = priceCheckService.checkPrices(system, storeCode, stavka.getSifraRobe(), pricelist);
            ...
            stavkeXml.append(String.format(
                    "<stavke>" +
                            ...
                            "</stavke>",
                    stavka.getKolicina(),
                    prices.getCenZal(),             // prices[0]
                    stavka.getKolicina(),
                    prices.getMpSaPdv(),            // prices[2]
                    prices.getMpSaPdv(),            // prices[2]
                    prices.getMpBezPdv(),           // prices[1]
                    prices.getMpSaPdv(),
